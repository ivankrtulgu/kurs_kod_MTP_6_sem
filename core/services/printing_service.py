...
class PrintingService:
    ...
    def generate_qr_pdf(
        ...
        try:
            ...
            pdf.cell(cell_width, label_h, txt=item_label, ln=False, align='C')
            ...
            if is_pair:
                ...
                pdf.cell(cell_width, label_h, txt=book_label or "Произведение", ln=False, align='C')
    ...
    def generate_batch_qr_pdf(
        ...
        try:
            ...
            def draw_cell(pdf, x, y, cell_width, cell_height, qr_path, label, qr_size, padding, label_h, font_name, dynamic_font_size):
                ...
                pdf.set_xy(x, qr_y + qr_size + 1)
                pdf.cell(cell_width, label_h, txt=label, ln=False, align='C')
                return qr_x, qr_y
            ...
            if mode == "book_only":
                ...
                for item in items_data:
                    ...
                    # Проверка: поместится ли ячейка на текущей странице
                    if y + cell_height > page_height - margin:
                        # Ячейка не помещается - создаем новую страницу
                        pdf.add_page()
                        current_col = 0
                        current_row = 0
                        x = margin
